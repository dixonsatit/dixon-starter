...
class Route extends Model
{
    ...
    public function save(){
      if($this->validate()){
        ...
        if($this->isNewRecord){
          $model = $authManager->createPermission($this->name);
        }else{
          $model = $authManager->getPermission($this->getOldAttribute('name'));
    ...
    public function delete(){
      $model = Yii::$app->authManager->getPermission($this->name);
